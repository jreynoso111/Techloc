...
begin
  ...
  set "pt serial" = p.winner_serial,
      ...
      days_stationary = p.days_stationary,
      movement_status_v2 = p.movement_status_v2,
      movement_days_stationary_v2 = p.days_stationary,
  ...
  where v.shortvin = p.shortvin
    and (
      ...
      or v.days_stationary is distinct from p.days_stationary
      or v.movement_status_v2 is distinct from p.movement_status_v2
      or v.movement_days_stationary_v2 is distinct from p.days_stationary
...
select public.refresh_vehicle_movement_v2_batch(null::text[]);
